...
public class MyOpPrecedenceParser {
    private Lexer lexer;
    ...
    public MyOpPrecedenceParser(Lexer p) {
        lexer = p;
        operators = new HashMap<String,Precedence>();
        operators.put("||", new Precedence(1, true));
        operators.put("&&", new Precedence(2, true));
        operators.put("==", new Precedence(3, false));
        operators.put("neq", new Precedence(3, false));
        operators.put("<", new Precedence(4, true));
        operators.put(">", new Precedence(4, true));
        operators.put("+", new Precedence(5, true));
        operators.put("-", new Precedence(5, true));
        operators.put("*", new Precedence(6, true));
        operators.put("/", new Precedence(6, true));
    }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        MyOpPrecedenceParser p = new MyOpPrecedenceParser(lexer);
